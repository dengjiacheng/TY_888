...
namespace AutoBet
{
    class PlatformHttpService
    {
        ...
        public static RestClient client_cart = new RestClient();
        public static RestClient client_login = new RestClient();
        public static Dictionary<string, string> host_dic = new Dictionary<string, string>() {
        ...
        public static Dictionary<string, string> referer_dic = new Dictionary<string, string>() {
            { "9393", "089393.app" },
            { "1717", "201717.app" },
            { "8868", "88681.hk" },
            { "6686", "196686.hk" },
        ...
        public static bool nonce(string platform, string currency, out dynamic data)
        {
            data = string.Empty;
            try
            {
                ...
                request.AddHeader("currency", currency);
        ...
        public static bool sendOtpSms(string platform, string currency, string phoneNumber, string clientNonce, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool login(string platform, string currency, string phoneNumber, string otpCode, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool query_orders(string platform, string currency, string token, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool query_amount(string platform, string currency, string token, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool bet(string platform, string currency, string token, int sid, int iid, int tid, string market, string beton, double odds, double k, int market_index, double ante, string score, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool Cart(string platform, string currency, int sid, int iid, string market, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool GetTournaments(string platform, string currency, int sid, out dynamic data)
        {
            data = string.Empty;
            try
            {
        ...
        public static bool Thirdparty(string platform, string currency, string token, out dynamic data)
        {
            data = null;
            try
            {
                var headers = new Dictionary<string, string>
                    {
                        ...
                        {"appversion", "3.89.12"},
                        {"currency", currency},
                        {"Referer", $"https://{referer_dic[platform]}/"}
                    };
